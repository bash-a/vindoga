    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            color: {
                ...
                if (list.activeFocus) return "lightblue" // activePalette.highlight
                else return "lightblue" // inactivePalette.highlight
            }
            ...
            Image {
                ...
                Image {
                    ...
                    sourceSize.height: height
                    sourceSize.width: width
                    source: "../ico/vindoga-installed.png"
...
//             }
            ...
            Button {
                ...
                onClicked: {
                    if (installed)
                        list.model.removePackage(fname)
                    else
                        list.model.installPackage(fname)
                }
            }
        }
    }
